...
<ul class="nav nav-pills justify-content-center gap-5 medi-subnav">
  ...
  <li class="nav-item">
    <a class="nav-link active" style="background-color: #ff69b4 !important" aria-current="page" href="${pageContext.request.contextPath}/oho/community/media/membership?artGroupNo=${param.artGroupNo}">멤버쉽 미디어</a>
  </li>
  <li class="nav-item">
...
<div class="album pt-0 py-5 bg-body-tertiary px-6">
	<div class="grid text-center pt-5 mb-5">
	  ...
	  <div class="g-col-4"><h2>멤버쉽 미디어</h2></div>
	  <div class="g-col-4"></div>
</div>
