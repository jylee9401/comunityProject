		...
		success:function(data){
	        ...
	        if(stat2!=null && gubun === "GD02"){
		        ...
		        */
		        ...
		        $("#spnTot").html(sumInt);
	        } else if (gubun === "GD01" && stat1.length > 0) {
	            // 굿즈 매출 총합 계산
	            let goodsSum = stat1.reduce((acc, item) => acc + Number(item.totalRevenue), 0);
	            $("#spnTot").html(goodsSum);
	        } else {
	            $("#spnTot").html(0);  // 데이터 없으면 0으로 표시
	        }
		}
	});
}
