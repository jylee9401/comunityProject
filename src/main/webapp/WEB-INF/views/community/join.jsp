...
<div class="profile-container">
    <div>
        <button type="button"  style="text-align: center; display: inline-block;" class="btn btn-secondary w-20 mt-2" onclick="history.back();">뒤로가기</button>
    </div>
    <form action="/oho/community/joinPost" method="post" enctype="multipart/form-data">
        ...
        <div class="text-center">
            ...
            <c:forEach var="fileDetailVO" items="${communityProfileVO.fileGroupVO.fileDetailVOList}">
                        <img src="/upload${fileDetailVO.fileSaveLocate}" class="profile-img" id="profileImg">
                    </c:forEach>
                </c:when>
                <c:otherwise>
                    <img src="/images/default-profile.png" class="profile-img" id="profileImg">
                </c:otherwise>
            </c:choose>
        ...
        <div class="mt-4">
            ...
            <input class="form-control" type="text" value="${communityProfileVO.comNm}" oninput="toggleSubmitButton()" name="comNm" id="comNm">
        </div>

        <!-- 버튼 -->
        <div class="mt-4">
            <button type="submit"  id="submitBtn" class="btn btn-custom" style="background-color: tomato;" disabled>가입완료</button>
        </div>
    </form>
</div>
...
function toggleSubmitButton() {
    const textArea = document.getElementById("comNm");
